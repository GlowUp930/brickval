...
The production detector can be switched through Vercel environment variables. The current custom detector source is the LEGO dataset under CC BY 4.0: https://universe.roboflow.com/object-detection-3oawx/lego-364li
