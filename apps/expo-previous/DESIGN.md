...
This is archived design guidance for the previous Expo/React Native app.

The active mobile app is the native Swift app in `../ios-swift/`. Use this file only as migration reference unless a task explicitly asks for Expo.
