...
const ACCENT_OPTIONS = [
  { key: "green", label: "Portfolio green", swatch: accents.green.primary },
  { key: "yellow", label: "Brick yellow", swatch: accents.yellow.primary },
  { key: "blue", label: "Market blue", swatch: accents.blue.primary },
] as const;
        ...
        <View style={styles.appearancePanel}>
          ...
          <View style={styles.accentOptions}>
            {ACCENT_OPTIONS.map((option) => {
              const selected = accentPreference === option.key;
              return (
                <Pressable
                  key={option.key}
                  accessibilityRole="button"
                  ...
                  onPress={() => {
                    tap();
                    setAccentPreference(option.key);
                  }}
