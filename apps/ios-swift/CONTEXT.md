...
- Onboarding is a three-stage flow: a brief BrickValue brand screen transitions automatically to a looping product demo, then "Get Started" opens a final Save Your Progress screen. The demo offers the full branded auth sheet, the final screen offers direct Apple and Google authentication, and "Skip for now" enters as a guest; account creation remains optional.
