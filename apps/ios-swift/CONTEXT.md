...
- Onboarding preserves the original value, scan-reveal, collector-goal, market-data, and collector-review sequence. A brief BrickValue brand screen and larger looping product demo precede those pages; the final Save Your Progress screen offers direct Apple and Google authentication, while "Skip for now" enters as a guest. The video screen also offers the full branded auth sheet, so account creation remains optional throughout.
