...
- App Store Connect has scheduled the experiment pricing for 2026-08-12: AUD 79.99 annual with a seven-day trial and AUD 9.99 monthly without a trial. The monthly adjustment covers 158 affected territories and lowers renewals for existing subscribers paying the higher monthly price in those territories. RevenueCat's live `default` offering includes both products. Superwall campaign `101303` maps `onboarding_hard_access` to the separate BrickValue-branded active paywall `254889`; a clean Debug simulator install verified the hard gate and automatic paywall presentation. Keep the experiment disabled until an on-device check after 2026-08-12 confirms the paywall displays the new App Store prices and trial.
